...
with st.container():
    st.markdown(f"""
        <div style='background-color: rgba(171, 235, 210, 0.75); padding: 1rem; margin-left: -3.5rem; margin-right: -3.5rem; margin-top: -2rem; border-radius: 0 0 12px 12px; text-align: left;'>
